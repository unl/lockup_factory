...
$query = "INSERT INTO `lockups` (`template_id`, `status`, `user_id`, `institution`, `department`, `generating`, `is_generated`, `creative_status`,  `communicator_status`, `public`, `approver_id`, `organization`, `date_created`) VALUES ('".$lockup['template_id']."', '0', '".$lockup['user_id']."', 'org', 'testName', '0', '0', '".$lockup['creative_status']."', '".$lockup['communicator_status']."', '".$lockup['public']."', '".$lockup['approver_id']."', '".$lockup['organization']."', '".$lockup['date_created']."');";

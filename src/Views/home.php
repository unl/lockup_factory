    ...
    <div class="wdn-inner-wrapper">
		<div class="bp2-wdn-grid-set-halves wdn-center">
            <div class="wdn-col" style="margin-bottom: 10px;">
            	<a href="/lockups/create/" class="wdn-button wdn-button-brand">Create a New Lockup</a>
            </div>
            <div class="wdn-col">
            	<a href="/lockups/manage/" class="wdn-button wdn-button-brand">Manage my Lockups</a>
            </div>
        </div>
	</div>
</div>
...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FWu-wxi2BZ', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F1NKzVBoWs', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pr6FWtEcjl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\LockupTemplatesCategoriesRepository' => ['privates', 'App\\Repository\\LockupTemplatesCategoriesRepository', 'getLockupTemplatesCategoriesRepositoryService', true],
            'App\\Repository\\LockupTemplatesFieldsMapRepository' => ['privates', 'App\\Repository\\LockupTemplatesFieldsMapRepository', 'getLockupTemplatesFieldsMapRepositoryService', true],
            'App\\Repository\\LockupTemplatesFieldsRepository' => ['privates', 'App\\Repository\\LockupTemplatesFieldsRepository', 'getLockupTemplatesFieldsRepositoryService', true],
            'App\\Repository\\LockupTemplatesRepository' => ['privates', 'App\\Repository\\LockupTemplatesRepository', 'getLockupTemplatesRepositoryService', true],
            'App\\Repository\\LockupsFieldsRepository' => ['privates', 'App\\Repository\\LockupsFieldsRepository', 'getLockupsFieldsRepositoryService', true],
            'App\\Repository\\LockupsRepository' => ['privates', 'App\\Repository\\LockupsRepository', 'getLockupsRepositoryService', true],
            'App\\Repository\\UsersRepository' => ['privates', 'App\\Repository\\UsersRepository', 'getUsersRepositoryService', true],
        ], [
            'App\\Repository\\LockupTemplatesCategoriesRepository' => '?',
            'App\\Repository\\LockupTemplatesFieldsMapRepository' => '?',
            'App\\Repository\\LockupTemplatesFieldsRepository' => '?',
            'App\\Repository\\LockupTemplatesRepository' => '?',
            'App\\Repository\\LockupsFieldsRepository' => '?',
            'App\\Repository\\LockupsRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WYSrK1HkYf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('o53O3+JOPl', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0gvQ1QV7qd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lDfeCuYK-H', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('APwk6LwzmY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KAflut+ajm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IT+75L4NMD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/digitalcampusframework/dcf-symfony-framework/Resources/views'), 'DCFFramework');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/digitalcampusframework/dcf-symfony-framework/Resources/views'), '!DCFFramework');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/unl/wdn-symfony-framework/Resources/views'), 'WDNFramework');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/unl/wdn-symfony-framework/Resources/views'), '!WDNFramework');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'DCFFrameworkBundle' => 'DCF\\Bundle\\FrameworkBundle\\DCFFrameworkBundle',
                'WDNFrameworkBundle' => 'WDN\\Bundle\\FrameworkBundle\\WDNFrameworkBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'DCFFrameworkBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/digitalcampusframework/dcf-symfony-framework'),
                    'namespace' => 'DCF\\Bundle\\FrameworkBundle',
                ],
                'WDNFrameworkBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/unl/wdn-symfony-framework'),
                    'namespace' => 'WDN\\Bundle\\FrameworkBundle',
                ],
                'WebpackEncoreBundle' => [

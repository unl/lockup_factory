...
/* wdn/templates_5.2/js/dcf-modal.js */
class __TwigTemplate_1a3456ee7711be0316af2d01fd83f6cb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.2/js/dcf-modal.js"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.2/js/dcf-modal.js"));
...
var DCFModal = function () {
  ...
  _createClass(DCFModal, [{
    ...
    value: function setNavToggleBtnState(btn) {
      ...
      // Set SVG state
      if (btnSVGs.length) {
        var gTags = btnSVGs[DCFUtility.magicNumbers('int0')].getElementsByTagName('g');
      ...
      if (btnLabels.length) {
        if (btnState.toLowerCase() === 'open') {
          btnLabels[DCFUtility.magicNumbers('int0')].textContent = btn.getAttribute('data-nav-toggle-label-open') ? btn.getAttribute('data-nav-toggle-label-open') : 'Open';
        } else {
          btnLabels[DCFUtility.magicNumbers('int0')].textContent = btn.getAttribute('data-nav-toggle-label-closed') ? btn.getAttribute('data-nav-toggle-label-closed') : 'Close';
        }
      }
    }
    ...
    value: function openModal(modalId, openBtnId) {
      ...
      var firstTabFocusEl = tabFocusEls[DCFUtility.magicNumbers('int0')];
      var lastTabFocusEl = tabFocusEls[tabFocusEls.length - DCFUtility.magicNumbers('int1')];
    ...
    value: function escListen() {
      ...
      document.addEventListener('keydown', function (event) {
        ...
        if (event.which === DCFUtility.magicNumbers('escCode') && _this5.currentModal) {
          event.preventDefault();
    ...
    value: function initialize() {
      ...
      btnsToggleModal.forEach(function (button) {
        var modalId = button.getAttribute('data-toggles-modal');

        // Generate unique ID for each 'open modal' button
        var btnId = DCFUtility.uuidv4();
      ...
      for (var modalIndex = 0; modalIndex < this.modals.length; modalIndex++) {
        ...
        var modalHeadingId = modalId + '-heading';
        ...
        if (modalWrapper.classList.length === DCFUtility.magicNumbers('int1') && modalWrapper.classList.contains('dcf-modal-wrapper')) {
        ...
        if (modalHeader.classList.length === DCFUtility.magicNumbers('int1') && modalHeader.classList.contains('dcf-modal-header')) {
        ...
        if (btnCloseModal.classList.length === DCFUtility.magicNumbers('int1') && btnCloseModal.classList.contains('dcf-btn-close-modal')) {
        ...
        if (modalContent.classList.length === DCFUtility.magicNumbers('int1') && modalContent.classList.contains('dcf-modal-content')) {
...
";
    ...
    {
        return "wdn/templates_5.2/js/dcf-modal.js";
    }
...
", "wdn/templates_5.2/js/dcf-modal.js", "/Users/abhirijal/unl_lockup_factory/templates/wdn/templates_5.2/js/dcf-modal.js");
    }
}

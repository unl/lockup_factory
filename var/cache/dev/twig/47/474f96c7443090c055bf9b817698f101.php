...
/* wdn/templates_5.3/js/unlalert.js */
class __TwigTemplate_ea9aa13ebcb34d25975704593bbae920 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.3/js/unlalert.js"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.3/js/unlalert.js"));

        // line 1
        echo "\"use strict\";

define(['wdn', 'jquery', 'css!js-css/unlalert'], function (WDN, \$) {
  ...
  var activeIds = [],
      ...
      axnSuf = '_action',
      timeoutPeriod = 30,
      // how ofter to check for expired data in seconds
  dataLifetime = 30,
      // seconds until the data cookie expires
  ackLifetime = 3600,
      // seconds until an acknowledgment expires
  _getClosedAlerts = function _getClosedAlerts() {
    ...
    return [];
      ...
      _pushClosedAlert = function _pushClosedAlert(id) {
    ...
    WDN.setCookie(ckPrfx + 'C', closed.join(','), ackLifetime);
      ...
      _checkCookie = function _checkCookie(name) {
    ...
    return false;
      ...
      _dataHasExpired = function _dataHasExpired() {
    return !_checkCookie(ckPrfx + 'Data');
  },
      _hasPreviousAlert = function _hasPreviousAlert() {
    return _checkCookie(ckPrfx + 'A');
  },
      _flagPreviousAlert = function _flagPreviousAlert(flag) {
    ...
    WDN.setCookie(ckPrfx + 'A', value, time);
      ...
      _callServer = function _callServer() {
    ...
    \$('<script>', {
      ...
      _checkIfCallNeeded = function _checkIfCallNeeded() {
    ...
    calltimeout = setTimeout(_checkIfCallNeeded, timeoutPeriod * 1000);
      ...
      dataReceived = function dataReceived() {
    WDN.log('UNL Alert data received');
    clearTimeout(calltimeout); // Set cookie to indicate time the data was acquired

    WDN.setCookie(ckPrfx + 'Data', 1, dataLifetime);
    calltimeout = setTimeout(_checkIfCallNeeded, (dataLifetime + 1) * 1000);
  },
      alertWasAcknowledged = function alertWasAcknowledged(id) {
    var closed = _getClosedAlerts();

    return closed.indexOf(id) != -1 ? true : false;
  },
      _acknowledgeAlert = function _acknowledgeAlert(id) {
    _pushClosedAlert(id);
  },
      _toggleAlert = function toggleAlert() {
    ...
    if (\$alert.hasClass('show')) {
      ...
      alertUser = function alertUser(root) {
    ...
    for (i = 0; i < info.length; i++) {
      ...
      if (!\$alertWrapper.length) {
        ...
        \$('<div>', {
          'class': 'dcf-wrapper'
        }).append(\$alertContent).appendTo(\$alertWrapper);
      } else if (i === 0) {
    ...
    if (!\$alertToggle.length) {
      \$alertToggle = \$('<button>', {
        ...
        'id': idPrfx + axnSuf
      }).text('Show emergency alert')).click(_toggleAlert).appendTo(\$alertContent.parent());
    }
  ...
  window.unlAlerts = {
    ...
    server: {
      init: function init() {
        dataReceived(); // There is an alert if NOT in an iframe and unlAlerts.data.alert.info exists
...
";
    ...
    {
        return "wdn/templates_5.3/js/unlalert.js";
    }
...
", "wdn/templates_5.3/js/unlalert.js", "/Users/abhirijal/unl_lockup_factory/templates/wdn/templates_5.3/js/unlalert.js");
    }
}

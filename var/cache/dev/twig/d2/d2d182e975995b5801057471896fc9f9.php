...
/* wdn/templates_5.3/js/dcf-modal.js */
class __TwigTemplate_53dd4d717eda9fe8d0d2b6faed9a3884 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.3/js/dcf-modal.js"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.3/js/dcf-modal.js"));
  ...
  var DCFModal = /*#__PURE__*/function () {
    ...
    _createClass(DCFModal, [{
      ...
      value: function setNavToggleBtnState(btn) {
        ...
        if (btnSVGs.length) {
          var gTags = btnSVGs[_dcfUtility.DCFUtility.magicNumbers('int0')].getElementsByTagName('g');

          Array.from(gTags).forEach(function (tag) {
        ...
        if (btnLabels.length) {
          if (btnState.toLowerCase() === 'open') {
            btnLabels[_dcfUtility.DCFUtility.magicNumbers('int0')].textContent = btn.getAttribute('data-nav-toggle-label-open') ? btn.getAttribute('data-nav-toggle-label-open') : 'Open';
          } else {
            btnLabels[_dcfUtility.DCFUtility.magicNumbers('int0')].textContent = btn.getAttribute('data-nav-toggle-label-closed') ? btn.getAttribute('data-nav-toggle-label-closed') : 'Close';
          }
        }
      } // Open modal
      ...
      value: function openModal(modalId, openBtnId) {
        ...
        var preOpenEventName = \"ModalPreOpenEvent_\".concat(modalId);
        document.dispatchEvent(new CustomEvent(preOpenEventName)); // Set elements outside of modal to be inert and hidden from screen readers
        ...
        var handleTrapFocus = function handleTrapFocus(event) {
          var keycodeTab = 9;

          var firstTabFocusEl = tabFocusEls[_dcfUtility.DCFUtility.magicNumbers('int0')];

          var lastTabFocusEl = tabFocusEls[tabFocusEls.length - _dcfUtility.DCFUtility.magicNumbers('int1')];
        ...
        thisModal.addEventListener('keydown', handleTrapFocus); // Remove keydown listener on close so updated on next open

        document.addEventListener(\"ModalCloseEvent_\".concat(modalId), function () {
        ...
        var openEventName = \"ModalOpenEvent_\".concat(modalId);
      ...
      value: function closeModal(modalId) {
        ...
        var navToggleGroupParent = navToggleGroup && navToggleGroup.parentElement ? navToggleGroup.parentElement : null;
        var thisModal = document.getElementById(modalId);
        var confirmClose = thisModal.dataset.confirmClose;
        ...
        var preCloseEventName = \"ModalPreCloseEvent_\".concat(modalId);
        document.dispatchEvent(new CustomEvent(preCloseEventName));
        /* eslint-disable */
        // Allow non-custom confirm
      ...
      value: function escListen() {
        ...
        document.addEventListener('keydown', function (event) {
          ...
          if (_dcfUtility.DCFUtility.isKeyEvent(event, _dcfUtility.DCFUtility.keyEvents('escape')) && _this5.currentModal) {
            event.preventDefault();
      ...
      value: function initialize() {
        ...
        btnsToggleModal.forEach(function (button) {
          ...
          var btnId = _dcfUtility.DCFUtility.uuidv4();
        ...
        for (var modalIndex = 0; modalIndex < this.modals.length; modalIndex++) {
          ...
          var modalHeadingId = \"\".concat(modalId, \"-heading\");
          var deliberateCloseOnly = typeof modal.dataset.deliberateCloseOnly !== 'undefined' && modal.dataset.deliberateCloseOnly.toLowerCase() !== 'false'; // Get all headings in each modal header

          var modalHeadings = modalHeader.querySelectorAll('h1, h2, h3, h4, h5, h6'); // Set ID on the first heading of each modal

          modalHeadings[_dcfUtility.DCFUtility.magicNumbers('int0')].id = modalHeadingId; // Append modals to body so that elements outside of modal can be hidden when modal is open
          ...
          if (modal.classList.length === _dcfUtility.DCFUtility.magicNumbers('int1') && modal.classList.contains('dcf-modal')) {
          ...
          if (modalWrapper.classList.length === _dcfUtility.DCFUtility.magicNumbers('int1') && modalWrapper.classList.contains('dcf-modal-wrapper')) {
          ...
          if (modalContent.classList.length === _dcfUtility.DCFUtility.magicNumbers('int1') && modalContent.classList.contains('dcf-modal-content')) {
...
";
    ...
    {
        return "wdn/templates_5.3/js/dcf-modal.js";
    }
...
", "wdn/templates_5.3/js/dcf-modal.js", "/Users/abhirijal/unl_lockup_factory/templates/wdn/templates_5.3/js/dcf-modal.js");
    }
}

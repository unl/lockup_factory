...
/* wdn/templates_5.3/js/search.js */
class __TwigTemplate_5ad50a67436e97a7b863fb90f68bc753 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.3/js/search.js"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "wdn/templates_5.3/js/search.js"));
...
define(['wdn', 'dcf-modal'], function (WDN, modalModule) {
  ...
  return {
    initialize: function initialize() {
      ...
      var modal = new modalModule.DCFModal([]); // Get Search links and buttons
      ...
      var domMobileSearchBtns = document.getElementsByClassName('dcf-mobile-search-button'); // Disable links and Enable buttons
      ...
      if (domDesktopSearchLink && domDesktopSearchBtns && domDesktopSearchBtns.length) {
        ...
        for (var _i = 0; _i < domDesktopSearchBtns.length; _i++) {
          ...
          _searchBtn.innerHTML = domDesktopSearchLink.innerHTML; // Toggle mobile nav state on desktop open click
      ...
      siteHomepage = location.protocol + '//' + location.host + '/',
          ...
          closeIDMOptionsEvent = new CustomEvent('closeDropDownWidget', {
        detail: {
          type: 'idm-logged-in'
        }
      }),
          localSearch = getLocalSearch(); // Give up if the search form has been unexpectedly removed
      ...
      \$progress.innerText = 'Loading...'; // Add an input to the form to let the search application know that we want the embedded format
      ...
      var onOpenSearchModalEvent = function onOpenSearchModalEvent() {
        ...
        document.dispatchEvent(closeIDMOptionsEvent); // Put focus on search text input
      ...
      var onCloseSearchModalEvent = function onCloseSearchModalEvent() {
        ...
        domSearchForm.reset(); // Clear results
      ...
      }, false); // Add an event listener to support the iframe rendering

      domQ.addEventListener('keyup', function (e) {
        var keyCode = e.keyCode; // Ignore non-printable keys (blacklist)
        ...
        if (this.value) {
          // Activate search UI
          createSearchFrame();
          activateSearch(); // Debounce auto-submit
...
";
    ...
    {
        return "wdn/templates_5.3/js/search.js";
    }
...
", "wdn/templates_5.3/js/search.js", "/Users/abhirijal/unl_lockup_factory/templates/wdn/templates_5.3/js/search.js");
    }
}
